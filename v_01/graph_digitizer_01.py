...
#            has_origin = np.any(np.isclose(x_out, 0.0) & np.isclose(y_out, 0.0))
#            if not has_origin:
#                x_out = np.concatenate([x_out, np.array([0.0])])
#                y_out = np.concatenate([y_out, np.array([0.0])])
